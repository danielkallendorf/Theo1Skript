...
\begin{itemize}
	...
	\end{align*}
		\item Mit $E_{rel}=\frac{\mu}{2}\dot{\vec r}^2+U(r)$
	\begin{align*}
	...
	\end{equation*}
	Wobei $+$ für $r(t)>r(t_0)$, $-$ für $r(t)<r(t_0)$, sonst $0$.
\end{itemize}

\begin{wrapfigure}{hl}{5cm}
...
\end{align*}
Die Lösungen unterschieden sich also je nach dem, wie groß $E_0$ ist. (Siehe Abbildung \ref{fig:E0} und Abbildung \ref{fig:Bahnkurven})
\begin{figure}[h]
	\begin{tabular}{|ccc|}
		\hline&
		\begin{tikzpicture}[scale=0.5]
...
\begin{proof}
	...
	\begin{align*}
		...
		\dif{H}{q_j}&=-\dif{L}{q_j}&&\text{Hamilton I}&&\\
		\dif{H}{t}&=-\dif{L}{t}&&\text{Hamilton II}&&
		\intertext{Weiterhin}
	\end{align*}
...
Es gilt: Sei $q_1$ eine Zyklische Koordinate\\
