...
\end{align*}
mit Orthogonalmatrix $O$, $Q=O^TM^{\frac{1}{2}}\eta$, $M^{-\frac{1}{2}}KM^{-\frac{1}{2}}=OKO^T$\\
...
\begin{align*}
L(\eta,\dot{\eta})&=\frac{1}{2}\dot\eta^T M\dot\eta-\frac{1}{2}\eta^TK\eta
&&=\frac{1}{2}(M^{\frac{1}{2}}\dot\eta)^T(M^\frac{1}{2}\eta)-\frac{1}{2}\eta^TK\eta&&\\
&=\frac{1}{2}\dot{\ol{Q}}^T\dot{\ol{Q}}-\frac{1}{2}\dot{\ol{Q}}^T\ol{Q}-\dfrac{1}{2}\ol{Q}^TM^{-\frac{1}{2}}KM^{-\frac{1}{2}}\ol Q
&&=\frac{1}{2}\dot Q^T\dot Q-\dfrac{1}{2}Q^TKQ&&
\end{align*}
...
\begin{align*}
	...
	=i\underbrace{\left[\frac{\hbar\omega_0}{V_0}\right]}_{:=1/\lambda} \underbrace{\dif{\Psi}{t \omega_0}}_{:=\tau}
\end{align*}
